...
## Environments
- Preview: https://main--dentsply-sirona--adobedevxsc.aem.page/
- Live: https://main--dentsply-sirona--adobedevxsc.aem.live/
...
1. Open the `dentsply-sirona` directory in your favorite IDE and start coding :)
